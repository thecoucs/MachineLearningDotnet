...
string _trainDataPath = Path.Combine(_appPath, "..", "..", "..", "Datos", "issues_train.tsv");
string _testDataPath = Path.Combine(_appPath, "..", "..", "..", "Datos", "issues_test.tsv");
string _modelPath = Path.Combine(_appPath, "..", "..", "..", "Modelos", "model.zip");
